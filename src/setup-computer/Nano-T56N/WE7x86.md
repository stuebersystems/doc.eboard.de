...
> #### info::Modell
> Nano T56N (2GB Arbeitsspeicher / 320GB HD)
...
* Öffnen Sie die Datei `WE7x32_Nano-T56N.exe` per Doppelklick. Das Programm extrahiert einige temporären Dateien auf den lokalen Datenträger. Dies kann einige Minuten dauern.
...
![](../../images/WE7x86-Installer-Nano-T56N.jpg "Windows Embedded 7 32Bit Installer")
...
[folgendem Link]: https://download.stueber.de/bin/de/windowsembedded/usb-images/WE7x86_Nano-T56N.exe
