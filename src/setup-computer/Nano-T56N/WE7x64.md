...
> #### info::Modell
> Nano T56N (4GB Arbeitsspeicher / 320GB HD)
...
* Öffnen Sie die Datei `WE7x64_Nano-T56N.exe` per Doppelklick. Das Programm extrahiert einige temporären Dateien auf den lokalen Datenträger. Dies kann einige Minuten dauern.
...
![](../../images/WE7x64-Installer-Nano-T56N.jpg "Windows Embedded 7 64Bit Installer")
...
[folgendem Link]: https://download.stueber.de/bin/de/windowsembedded/usb-images/WE7x64_Nano-T56N.exe
