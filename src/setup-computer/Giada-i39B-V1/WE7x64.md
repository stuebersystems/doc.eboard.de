...
* Öffnen Sie die Datei `WE7x64_Giada-i39B.exe` per Doppelklick. Das Programm extrahiert einige temporären Dateien auf den lokalen Datenträger. Dies kann einige Minuten dauern.
...
![](../../images/WE7x64-Installer-Giada-i39B.jpg "Windows Embedded 7 64Bit Installer")
...
[folgendem Link]: https://download.stueber.de/bin/de/windowsembedded/usb-images/WE7x64_Giada-i39B.exe
