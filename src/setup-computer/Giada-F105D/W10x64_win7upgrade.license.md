# Windows 10 Professional \(64 Bit\) Image installieren: Windows 7 Upgrade-Lizenz
...
Wenn Ihre Windows-Lizenz `Windows 10 IOT ENT CBB ENTRY` lautet, wählen Sie die [entsprechende Anleitung](W10x64_win10-IOT-ENT-CBB-Entry-Licence.md) für diese Lizenz.
...
* Zunächst laden Sie bitte die [Image-Datei](ftp://ftp.stueber.de/pub/bin/de/windowsembedded/usb-images/Giada-F105D-ImageV1-5.img
...
Das Programm öffnet sich. Wählen Sie Ihren USB-Stick aus, suchen Sie die Image-Datei **Giada-F105D-ImageV1-5.img** per die Schaltfläche `Image` aus, anschließend wählen Sie `Image schreiben`.
