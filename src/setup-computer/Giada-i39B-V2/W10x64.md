...
> #### info::Modell
>
> Giada i39B V2 \(60GB HD\) Zum Ermitteln des Modells Ihres Rechners sehen Sie [hier](README.md#Bilder-Giada-i39B-V2) die Bilder dazu.
...
* Zunächst laden Sie bitte die [Image-Datei](https://download.stueber.de/bin/de/windowsembedded/usb-images/Giada-i39B-V2-ImageV1-4.img
...
Das Programm öffnet sich. Wählen Sie Ihren USB-Stick aus, suchen Sie die Image-Datei **Giada-i39B-V2-ImageV1-4.img** per die Schaltfläche `Image` aus, anschließend wählen Sie `Image schreiben`.
...
![](../../images/W10x64-Installer-Giada-i39B-V2.jpg "Windows 10 Professional 64Bit Installer")
...
* Unter `START` -> `Einstellungen` können Sie Ihren `Windows Product Key` eingeben. Dieser [befindet](README.md#Bilder-Giada-i39B-V2) sich auf der unteren Seite des Rechners.
