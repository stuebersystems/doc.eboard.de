...
* Öffnen Sie die Datei `WE7x86_Nano-E450.exe` per Doppelklick. Das Programm extrahiert einige temporären Dateien auf den lokalen Datenträger. Dies kann einige Minuten dauern.
...
![](../../images/WE7x86-Installer-Nano-E450.jpg "Windows Embedded 7 32Bit Installer")
...
[folgendem Link]: https://download.stueber.de/bin/de/windowsembedded/usb-images/WE7x86_Nano-E450.exe
